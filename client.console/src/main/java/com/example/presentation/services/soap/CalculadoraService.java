    ...
    extends Service
{
    ...
    private final static QName CALCULADORASERVICE_QNAME = new QName("http://soap.services.presentation.example.com/", "CalculadoraService");
    ...
    public Calculadora getCalculadoraPort() {
        return super.getPort(new QName("http://soap.services.presentation.example.com/", "CalculadoraPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.services.presentation.example.com/", "CalculadoraPort"), Calculadora.class, features);
    }
