...
Once the runtime starts, you can access the project at [http://localhost:8080/jakartaee-laboratorio-servlet](http://localhost:8080/jakartaee-laboratorio-servlet).
